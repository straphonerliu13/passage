class BookmarksController < ApplicationController
  ...
  def index
    ...
    @bookmarks = @q.result(:distinct => true).includes(:user, :attraction, :exhibit).page(params[:page]).per(10)
  end
  ...
  private
    ...
    def bookmark_params
      params.require(:bookmark).permit(:user_id, :exhibit_id, :attraction_id)
    end
end
